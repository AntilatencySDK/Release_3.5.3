...
Git command to clone this subset: `git clone --branch subset-f1cc078885a85d8e28041b1e1f557aef462f339c --single-branch https://github.com/AntilatencySDK/Release_3.5.3.git AntilatencySDK`
